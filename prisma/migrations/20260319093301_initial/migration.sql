...
-- CreateTable
CREATE TABLE [dbo].[FuelInputEntry] (
    [id] INT NOT NULL IDENTITY(1,1),
    [date] DATETIME2 NOT NULL,
    [supplier_name] NVARCHAR(1000),
    [vessel_name] NVARCHAR(1000),
    [volume_litres] FLOAT(53) NOT NULL,
    [temperature] FLOAT(53) NOT NULL,
    [density] FLOAT(53) NOT NULL,
    [gravity] FLOAT(53) NOT NULL,
    [sulphur_content] FLOAT(53) NOT NULL,
    [createdAt] DATETIME2 NOT NULL CONSTRAINT [FuelInputEntry_createdAt_df] DEFAULT CURRENT_TIMESTAMP,
    [updatedAt] DATETIME2 NOT NULL,
    CONSTRAINT [FuelInputEntry_pkey] PRIMARY KEY CLUSTERED ([id])
);
...
-- CreateTable
CREATE TABLE [dbo].[PipelineProgress] (
    [id] NVARCHAR(1000) NOT NULL,
    [distanceKm] FLOAT(53) NOT NULL CONSTRAINT [PipelineProgress_distanceKm_df] DEFAULT 0,
    [totalDistance] FLOAT(53) NOT NULL CONSTRAINT [PipelineProgress_totalDistance_df] DEFAULT 1710,
    [lastStation] NVARCHAR(1000),
    [updatedAt] DATETIME2 NOT NULL,
    CONSTRAINT [PipelineProgress_pkey] PRIMARY KEY CLUSTERED ([id])
);
