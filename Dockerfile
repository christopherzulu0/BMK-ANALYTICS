...
ENV DATABASE_URL="sqlserver://192.168.0.223:1433;databaseName=Pipelines;user=sa;password=87064465_Cz;integratedSecurity=false;trustServerCertificate=true;encrypt=true;"
